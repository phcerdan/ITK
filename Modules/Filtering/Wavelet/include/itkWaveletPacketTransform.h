...
#include "itkWaveletPacketDecompositionCosts.h"
 ...
 * and implementation.
 *
 * The user is supposed to initialize Cost properly (through SetCost() macro)
...
public:
  ...
  itkSetObjectMacro(Cost, CostType);
...
#include "itkWaveletPacketTransform.hxx"
#endif
