...
#ifndef itkWaveletPacketTransform_hxx
#define itkWaveletPacketTransform_hxx
...
::GenerateOutputInformation()
{
  ...
  itkDebugMacro(<< "Output Size [" << outputSize[0] << "," << outputSize[1] << "]");
...
::GenerateData()
{
  ...
  itkDebugMacro(<< "nbFilter  = " << m_NumberOfFilters);
  itkDebugMacro(<< "depth     = " << m_DepthOfDecomposition);
  itkDebugMacro(<< "rule size = " << m_WaveletPacketRule.size());
