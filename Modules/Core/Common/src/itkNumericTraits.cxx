...
template<>
std::complex< char >  NumericTraits< std::complex< char > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< char >  NumericTraits< std::complex< char > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< unsigned char >  NumericTraits< std::complex< unsigned char > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< unsigned char >  NumericTraits< std::complex< unsigned char > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< short >  NumericTraits< std::complex< short > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< short >  NumericTraits< std::complex< short > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< unsigned short >  NumericTraits< std::complex< unsigned short > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< unsigned short >  NumericTraits< std::complex< unsigned short > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< int >  NumericTraits< std::complex< int > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< int >  NumericTraits< std::complex< int > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< unsigned int >  NumericTraits< std::complex< unsigned int > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< unsigned int >  NumericTraits< std::complex< unsigned int > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< long >  NumericTraits< std::complex< long > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< long >  NumericTraits< std::complex< long > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< unsigned long >  NumericTraits< std::complex< unsigned long > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< unsigned long >  NumericTraits< std::complex< unsigned long > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< float >  NumericTraits< std::complex< float > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< float >  NumericTraits< std::complex< float > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< double >  NumericTraits< std::complex< double > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< double >  NumericTraits< std::complex< double > >::ZeroValue( const Self & ){
  return ZeroValue();
}
...
template<>
std::complex< long double >  NumericTraits< std::complex< long double > >::ZeroValue(){
  return Zero;
}
template<>
std::complex< long double >  NumericTraits< std::complex< long double > >::ZeroValue( const Self & ){
  return ZeroValue();
}
